...
let wow_config = vscode.workspace.getConfiguration("daemonicAPI");

const author = "amstaffix";
const extensionName = "daemonic-lua-api";
...
vscode.workspace.onDidChangeConfiguration((event: vscode.ConfigurationChangeEvent) => {
	...
	if (event.affectsConfiguration("daemonicAPI")) {
		wow_config = vscode.workspace.getConfiguration("daemonicAPI");
		if (event.affectsConfiguration("daemonicAPI.luals.configurationScope")) {
			configLuaLS(true);
		}
	}
});
